...
class Addresses extends StatefulHookWidget {
  ...
  const Addresses({super.key, this.refetch,   });
        ...
        body: Container(
          ...
          child: isSearching
                          ...
                          child: ListTile(
                            ...
                            onTap: () async{
                              ...
                              var model = AddressModel(
                                  ...
                                  postalCode: postalCode.isNotEmpty ? postalCode : 'N/A',
                              ...
                              addressController.addAddressProfile(data,refetch!, context);
                            },
                          ),
                        );
                      },
              ...
              : isLoading
                  ...
                  : AddressListWidget(addresses: addresses, refetch: refetch,),
        ),
      ),
    );
  }
